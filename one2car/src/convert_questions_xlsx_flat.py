...
# File paths
source_file = 'one2car/input/thai_v3.xlsx'
dest_file = 'one2car/output/thai_v3_flat.xlsx'
...
for idx, row in df.iterrows():
    ...
    if qid is not None:
        ...
        #print(f"xxxxxxxxxxxxxxxxxxxx| {question_text} :| Processing suffixes: {suffixes} ")
        for i, opt in enumerate(options, 1):
            ...
            #if(len(suffixes)> 0):
            #    print(f"yyyyyyyyyyyyyyyyyyyy Processed row: {rows[-1]}")
